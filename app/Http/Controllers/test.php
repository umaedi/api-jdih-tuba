...
$servername = "36.91.91.238";//diisi nama server
$username = "kominfo";//diisi nama user db
$password = "3xNXpGa15t6iu0x7JpWi";//diisi password db
$dbname = "jdih";//diisi nama database
$varjson = array();
...
-- WHERE document.id >= 78731
WHERE document.is_publish=1"; //query sql yang disesuaikan
...
$row_array->tanggal_penetapan=$row["sc_penetapan"]; //berisi tahun bulan tanggal (YYYY-MM-DD) ex. 2019-04-22
